        ...
        <div class="edit-lesson-form">
          ...
          >
            ...
            <!-- <el-form-item prop="professionId" label="所属专业：">
              <el-select
                v-model="lessonFormData.professionId"
                @change="getProfessName(lessonFormData.professionId)"
                placeholder="请选择所属专业"
              >
                <el-option
            ...
            <el-row :gutter="20">
              <el-col :span="10">
                <el-form-item label="视频字幕识别语言" prop="defaultLangcode">
                  <el-select v-model="lessonFormData.defaultLangcode" placeholder="请选择视频字幕识别语言">
            ...
            <el-form-item class="form-buttons" size="medium">
              ...
              <el-button v-if="isNew" type="primary" @click="handleAddSubmit('add')">确认创建</el-button>
            </el-form-item>
          </el-form>
        </div>
      </div>
...
export default {
    ...
    methods: {
        ...
        handleAvatarSuccessVideo(res, file) {
            ...
            //console.log(this.lessonFormData.videoUrl)
            this.$message({
                message: '上传成功',
                type: 'success'
            })
