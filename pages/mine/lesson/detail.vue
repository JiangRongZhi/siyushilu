<template>
  <div class="lesson-detail-wrap">
    ...
    <div class="lesson-detail-bottom" v-if="active!='unpublished'">
      <div class="lesson-detail-info">
        ...
        <div>
          ...
          <el-col :span="8">
            <span class="lesson-text">录制时间：{{ lessonDetail.createTime | filterDate }}</span>
          </el-col>
          <el-col :span="8">
    ...
    <div class="lesson-detail-bottom" v-else>
      <div class="lesson-detail-info">
        <div>
          <el-col :span="12">
            <span class="lesson-text">上传者：{{ lessonDetail.teacherName }}</span>
...
export default {
    ...
    methods: {
        ...
        onselectTranslang(event) {
            if (event == this.transLangList[0].code) {
                this.subSet = true
            } else {
                this.subSet = false
            }
