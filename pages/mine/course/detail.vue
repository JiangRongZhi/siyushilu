<template>
  <div class="course-wrap">
    ...
    <div class="container-1200">
      <ManagerLeft :active="leftActive" class="manager-left" @change="handleLeftChange"></ManagerLeft>
    </div>
            ...
            <div class="catalog-list">
              <div v-for="(item, index) in catalogList" :key="index" class="catalog-item">
                <nuxt-link
                  ...
                  :key="c.id"
                  :to="{ path: '/lesson/detail', query: { id: c.lessonId,from:'mine-lesson-manager' } }"
                >
                  <span>{{c.chapter}}.{{c.section}}</span>
                  {{c.lessonName}}
                </nuxt-link>
              </div>
            </div>
...
import LessonList from '@/components/course/Lesson-List2.vue'
